...
useHead({
    ...
    meta: [
        { name: 'og:title', content: article.content.title },
        { name: 'og:description', content: article.content.description },
        { name: 'og:image', content: url.protocol + '//' + url.hostname + article.content.thumbnail },
    ],
})
useSeoMeta({
