  ...
  <main class="max-w-4xl mx-auto p-4">
    ...
    <div class="max-w-5xl mx-auto mt-10">
      <header class="flex items-center justify-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-center">パスワード作成ツール</h1>
      </header>
      <section>
        <header class="flex sm:items-center justify-between p-1">
          <div class="flex sm:items-end flex-col sm:flex-row">
            <h2 class="flex-grow text-xl">パスワード一覧</h2>
            <p class="text-sm sm:ml-4">※クリックでコピーできます</p>
          </div>
          <button
            type="button"
      ...
      <section class="mt-4">
        ...
        <form class="flex flex-col">
              ...
              <div class="flex flex-wrap flex-grow p-2 pl-4 bg-gray-200">
                ...
                >
                  <input
                    ...
                    :value="index"
                  />
                  <label :for="'password-length-' + passwordLength" class="pl-2">
                    {{ passwordLength }}文字
                  </label>
                </div>
                <div class="py-2">
                  ...
                  />
                  <label for="password-length-custom" class="pl-2">
                    <input
              ...
              <div class="flex flex-col p-2 pl-4 bg-gray-200 flex-grow">
                <div class="py-1">
                  <input
                    ...
                    name="include-option"
                  />
                  <label for="include-upper-alphabet" class="pl-2"> 英字(大文字) </label>
                </div>
                <div class="py-1">
                  <input
                    ...
                    name="include-option"
                  />
                  <label for="include-lower-alphabet" class="pl-2"> 英字(小文字) </label>
                </div>
                <div class="py-1">
                  <input
                    id="include-numeric"
                    ...
                    name="include-option"
                  />
                  <label for="include-numeric" class="pl-2"> 数字 </label>
                </div>
                <div class="py-1">
                  <input
                    id="include-symbol"
                    ...
                    name="include-option"
                  />
                  <label for="include-symbol" class="pl-2"> 記号 </label>
                  <input
              ...
              <div class="flex flex-col p-2 pl-4 bg-gray-50 flex-grow">
                <div class="py-1">
                  <input
                    ...
                    name="exclude-option"
                  />
                  <label for="exclude-mistake" class="pl-2">
                ...
                <div class="py-1">
                  <input
                    ...
                    name="exclude-option"
                  />
                  <label for="exclude-same-word" class="pl-2"> 同じ文字は含めない </label>
                </div>
              </div>
            </fieldset>
          </div>
          ...
          <div v-if="hasError" class="flex justify-center mt-4">
            <p
      ...
      <section class="my-4">
        <h2 class="text-xl border-b-2 border-gray-800 p-2 mb-2">使い方</h2>
        ...
        <dl>
          <dt class="text-lg bg-gray-200 rounded p-2 my-2">文字数</dt>
          <dd>
            <p style="text-indent: 1rem">
          ...
          <dt class="text-lg bg-gray-200 rounded p-2 my-2">個数</dt>
          <dd>
            <p style="text-indent: 1rem">
          ...
          <dt class="text-lg bg-gray-200 rounded p-2 my-2">含める文字</dt>
          <dd>
            <p style="text-indent: 1rem">
          ...
          <dt class="text-lg bg-gray-200 rounded p-2 my-2">その他</dt>
          <dd>
            <p style="text-indent: 1rem">その他の設定です。以下の2つが設定できます。</p>
